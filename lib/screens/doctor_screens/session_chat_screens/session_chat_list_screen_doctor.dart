...
import 'package:sickle_cell_app/screens/doctor_screens/session_chat_screens/session_chat_screen_doctor.dart';

class SessionChatListScreenDoctor extends ConsumerStatefulWidget {
  const SessionChatListScreenDoctor({super.key});

  @override
  ConsumerState<SessionChatListScreenDoctor> createState() =>
      _SessionChatListScreenDoctorState();
}

class _SessionChatListScreenDoctorState
    extends ConsumerState<SessionChatListScreenDoctor> {
  @override
  void initState() {
    super.initState();
  }
  ...
  void _getChats() async {
    ...
    try {
      ref
          ...
          .fetchSessionChatsByDoctorId(user!.doctorId!);
    } catch (e) {
                        ...
                        SingleChatRow(
                          ...
                          onChanged: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => SessionChatScreenDoctor(
                                  chat: chat,
                                ),
                              ),
                            );
