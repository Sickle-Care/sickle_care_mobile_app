...
class PatientListScreenAdmin extends ConsumerStatefulWidget {
  const PatientListScreenAdmin({super.key});

  @override
  ConsumerState<PatientListScreenAdmin> createState() =>
      _PatientListScreenAdminState();
}

class _PatientListScreenAdminState
    extends ConsumerState<PatientListScreenAdmin> {
  @override
  void initState() {
    super.initState();
  }
