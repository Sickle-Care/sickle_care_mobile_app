...
class DoctorListScreenAdmin extends ConsumerStatefulWidget {
  const DoctorListScreenAdmin({super.key});

  @override
  ConsumerState<DoctorListScreenAdmin> createState() =>
      _DoctorListScreenAdminState();
}

class _DoctorListScreenAdminState extends ConsumerState<DoctorListScreenAdmin> {
  @override
  void initState() {
    super.initState();
  }
                    ...
                    (doctor) => Column(
                      children: [
                        SingleDoctorRow(
                          ...
                          licenseNumber: doctor.doctorLicenseNumber ?? 'N/A',
                        ),
                        SizedBox(height: 5),
                      ],
                    ),
