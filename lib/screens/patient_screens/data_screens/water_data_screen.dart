...
class _WaterDataScreenState extends ConsumerState<WaterDataScreen> {
  ...
  void initState() {
    ...
    if (healthRecord != null) {
      _selectedGlasses = healthRecord.waterIntake.glassAmount;
    }
  }
  ...
  void updateWaterIntake(HealthRecord healthRecord) async {
    try {
      WaterIntake updatedWaterIntake = healthRecord.waterIntake
          .copyWith(glassAmount: _selectedGlasses, glassCount: _totalGlasses);
            ...
            children: [
              ...
              Center(
                child: CircularPercentIndicator(
                  ...
                  lineWidth: 13,
                  animation: true,
                  percent: healthRecord!.waterIntakePercentage,
                  center: Text(
